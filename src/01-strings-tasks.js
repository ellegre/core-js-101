...
function extractNameFromTemplate(value) {
  const str = value.replace('Hello, ', '').replace('!', '');
  return str;
}
...
function encodeToRot13(str) {
  return str.replace(/[A-Z]/gi, (letter) => 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm'['ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'.indexOf(letter)]);
}
